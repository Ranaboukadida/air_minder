          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                    'Discover your device Insights: Swipe through sensors to keep an eye on temperature, humidity and lightning .',
                    style: TextStyle(
                        fontSize: 15,
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: const [
                    ...
                    CustomCard(
                      title: 'Lightning',
                      description: 'Check the lightning !',
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20, right: 10, top: 3),
                child: Text('Check out the latest alerts from your device.',
                    style: TextStyle(
                        fontSize: 15,
                        color: Theme.of(context).colorScheme.onBackground)),
              ),
